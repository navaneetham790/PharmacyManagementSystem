...
public class Main { 
    public static void main(String[] args) { 
        ...
        medicines.add(new Medicine("M101", "Paracetamol 650mg", 25.0, 50, "2028-12-30", false));
        medicines.add(new Medicine("M102", "Amoxicillin 500mg", 120.0, 20, "2028-05-20", true));
        medicines.add(new Medicine("M103", "Cough Syrup", 80.0, 10, "2028-01-15", false));
